<div class="header-wrapper header-type-1<?php echo esc_attr($header_classes); ?>">
    <?php //!-- Top bar --
    do_action('before');
    $topbar_file = DIGI_CHILD_PATH . '/headers/top-bar-1.php';
    include is_file($topbar_file) ? $topbar_file : DIGI_THEME_PATH . '/headers/top-bar-1.php';
    //!-- End Top bar --
                        ...
                        <div class="large-12 columns">
                            <div class="row">
                                ...
                                <div class="static-block-wrapper large-2 columns">
                                    <?php echo digi_get_block(); ?>
                                </div>
                                <div class="large-8 columns">
                                    <div class="row">
                                        <div class="search-tatal-wrapper large-9 columns">
                                            <?php digi_search('full'); ?>
                                        </div>
                                        
                                        <div class="large-3 columns nasa-header-icons-type-1">
                                            <?php echo digi_header_icons(false, false, true); ?>
                                        </div>
                                    </div>
                                </div>
