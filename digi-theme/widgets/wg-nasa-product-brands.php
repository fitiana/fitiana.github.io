...
if (class_exists('WC_Widget') && class_exists('YITH_WCBR')) {
    ...
    add_action('widgets_init', 'digi_product_brands_widget');

    function digi_product_brands_widget() {
        register_widget('Digi_Product_Brands_Widget');
    }

    class Digi_Product_Brands_Widget extends WC_Widget {
        ...
        public function __construct() {
            ...
            $this->widget_description = esc_html__('Display product brands with Accordion.', 'digi-theme');
            $this->widget_id = 'nasa_product_brands';
            $this->widget_name = esc_html__('Nasa Product Brands', 'digi-theme');
            $this->settings = array(
                'title' => array(
                    'type' => 'text',
                    'std' => esc_html__('Product Brands', 'digi-theme'),
                ...
                /* 'orderby' => array(
                    ...
                    'options' => array(
                        'order' => esc_html__('Brand Order', 'digi-theme'),
        ...
        public function widget($args, $instance) {
            ...
            $menu_cat = new Digi_Product_Brand_List_Walker();
    ...
    class Digi_Product_Brand_List_Walker extends WC_Product_Cat_List_Walker {
        ...
        public function __construct() {
            $this->tree_type = Digi_Product_Brands_Widget::TAX_NAME;
        }
        ...
        public function start_el(&$output, $brand, $depth = 0, $args = array(), $current_object_id = 0) {
            ...
            $href = get_term_link((int) $brand->term_id, $this->tree_type);
