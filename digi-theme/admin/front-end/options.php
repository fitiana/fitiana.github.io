<div class="wrap" id="of_container">
    ...
    <form id="of_form" method="post" action="<?php echo esc_attr($_SERVER['REQUEST_URI']) ?>" enctype="multipart/form-data">
        <h2 style="display: none;"><?php esc_html_e('NasaTheme Options', 'digi-theme'); ?></h2>
        ...
        <div class="updated importer-notice importer-notice-2" style="display: none;"><p><strong><?php echo sprintf(esc_html__('Demo data successfully imported. Click Save All Changes. Go to Tools -> Regen. Thumbnails -> Click Regenerate All Thumbnails', 'digi-theme')); ?></strong></p></div>
