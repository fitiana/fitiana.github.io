...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'all-styles', get_template_directory_uri() . '/assets/css/all.min.css');
		...
		wp_enqueue_script( 'app', get_template_directory_uri() . '/assets/js/app.js', array(), $js_version, true );
